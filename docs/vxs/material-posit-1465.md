...
Unter den in "[Kalkulationsergebnisse](#showid/1409 "Kalkulationsergebnisse CalcResult")" aufgeführten Elementen gibt es das Element <MaterialPositions>, das mehrere <MaterialPosition>-Elemente enthält. Diese enthalten Informationen über die für die Reparatur verwendeten
Ersatzteile.
