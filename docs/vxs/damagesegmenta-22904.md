...
Unter den in "[Kalkulationsergebnisse](#showid/1409 "Kalkulationsergebnisse CalcResult")" aufgeführten Elementen gibt es das Element <DamageSegmentation>, das mehrere <DamageSegment>-Elemente enthält. Diese enthalten Informationen pro Schaden.
