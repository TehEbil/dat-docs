...
Unter den in "[Kalkulationsergebnisse](#showid/1409 "Kalkulationsergebnisse CalcResult")" aufgeführten Elementen gibt es das Element <InspectionPositions>, das mehrere <InspectionPosition>-Elemente enthält. Diese enthalten Informationen die kalkulierten HU/AU-Positionen.
