...
Unter den in "[Kalkulationsergebnisse](kalkulationser-1409.md)" aufgeführten Elementen gibt es das Element <LacquerPositions>, das mehrere <LacquerPosition>-Elemente enthält. Diese enthalten Informationen über die für die Reparatur notwendigen
Lackarbeiten.
