...
Unter den in "[Kalkulationsergebnisse](kalkulationser-1409.md)" aufgeführten Elementen gibt es das Element <AdditionalCostsPositions>, das mehrere <AdditionalCostsPosition>-Elemente enthält. Diese enthalten Informationen über Nebenkosten der Reparatur.
