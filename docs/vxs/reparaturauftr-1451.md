...
| InsuranceId | String | Eindeutige Kennungsnummer des Unternehmens in der Versicherungswirtschaft (nur selbstaendige Versicherungskonzerne, im Gegensatz zu InsuranceNumber), [hier](#showid/2113 "Versicherungen (Insurance)") finden Sie eine Liste der Versicherungs-IDs und dazugehörige Versicherung. |  |
| InsuranceGroupId | String | Versicherungsgruppe (über die Funktion [getInsurances](#showid/2333 "Abrufen von länderspezifischen Versicherungen") aufrufbar) |  |
| ServiceProviderId | String |  |  |
| InsuranceType | String | Versicherungsart | none = Haftpflicht  partial = Teilkasko  comprehensive = Vollkasko |
| InsuranceNumber | String | Eindeutige Kennungsnummer des Versicherungsunternehmens (im Gegensatz zu InsuranceID werden auch Tochterunternehmen des gleichen Konzerns unterschieden).  Über die Funktion [getInsurances](#showid/2333 "Abrufen von länderspezifischen Versicherungen") aufrufbar. |  |
...
| AdditionalData |  | s. [Zusatzdaten AdditionalData](#showid/1457 "Zusatzdaten AdditionalData") |  |
