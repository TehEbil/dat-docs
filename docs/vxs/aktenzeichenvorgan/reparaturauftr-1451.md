...
| InsuranceGroupId | String | Versicherungsgruppe (über die Funktion [getInsurances](../../produkte/silverdat-calculat/abrufen-von-la-2333.md) aufrufbar) |  |
| ServiceProviderId | String |  |  |
| InsuranceType | String | Versicherungsart | none = Haftpflicht  partial = Teilkasko  comprehensive = Vollkasko |
| InsuranceNumber | String | Eindeutige Kennungsnummer des Versicherungsunternehmens (im Gegensatz zu InsuranceID werden auch Tochterunternehmen des gleichen Konzerns unterschieden).  Über die Funktion [getInsurances](../../produkte/silverdat-calculat/abrufen-von-la-2333.md) aufrufbar. |  |
...
| AdditionalData |  | s. [Zusatzdaten AdditionalData](zusatzdaten-ad-1457.md) |  |
