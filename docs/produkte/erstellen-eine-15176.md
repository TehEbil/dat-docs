---
title: "Erstellen einer Bewertung im Speicher"
topic_id: "15176"
breadcrumb: "SilverDAT Produkte > SilverDAT 3 PRO > Schnittstellenoperationen > Bewertung > Verwalten von Vorgängen > Erstellen einer Bewertung im Speicher"
---

# Erstellen einer Bewertung im Speicher

Mit der Funktion doValuationInMemoryN erstellen Sie eine neue Bewertung im Speicher. Die Funktion doValuationInMemoryN unterstützt nicht die Variante mit unvollständiger Fahrzeugidentifikation.
   Um eine neue Bewertung zu erstellen, benötigen Sie mindestens das Dossier Element. Die Berechnungen der Preise sind hinsichtlich des Preislistendatums präziser
      als in der VIN-Abfrage.
   Das nachfolgende Beispiel zeigt ein Dossier Element mit den Feldern, die mindestens benötigt werden.
   Beispiel:
