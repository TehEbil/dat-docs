...
topic_id: "2366"
breadcrumb: "SilverDAT Produkte > SilverDAT calculatePro / SilverDAT calculateExpert > Schnittstellenoperationen > VehicleRepairService > Abfragen von DVNs anhand von DAT €uropa-Code, Bauzeit und AVs"
---
...
| --- | --- | --- | --- |
| constructionTime | String, optional |  | Bauzeit nach DAT-Notation, 4-stellig |
