...
| 1.5 | 03.11.2022 | Erweiterter Fullscreen Modus für die Oberflächenintegration zur größeren Darstellung des Arbeitsbereichs.  Weitere Infos im Kapitel [Direktes Aufrufen von myClaim über POST-Schnittstelle](../silverdat-3-pro/mogliche-fehle-2797.md). |
