...
Die Funktion listTemplates listet entsprechend nach [Vorlagentyp](vorlage-typen-2597.md) die vorhandenen Vorlagen auf und gibt diese jeweils mit Vorlagenname, Vorlagen ID,
