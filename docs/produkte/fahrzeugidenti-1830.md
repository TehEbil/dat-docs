---
title: "Fahrzeugidentifikation anhand KBA"
topic_id: "1830"
breadcrumb: "SilverDAT Produkte > DAT €uropa-Code® Fahrzeugauswahl > Fahrzeugidentifikation - Funktionen > Fahrzeugidentifikation anhand KBA"
---

# Fahrzeugidentifikation anhand KBA

Beschreibung

Die Funktion getVehicleIdentificationByKba liefert anhand des KBA-Schlüssels die möglichen DAT €uropa-Codes® und deren Marktindizes. Aufgrund der Masse der Informationen erfolgt die Speicherung
im VXS-Format.

Diese Operation führt eine vollständige Fahrzeugidentifizierung anhand des KBA-Schlüssels
...
| --- | --- | --- | --- | --- |
| kba | String | KBA-Schlüssel | Gültiger KBA | X |
