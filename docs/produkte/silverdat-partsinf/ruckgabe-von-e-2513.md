...
| intPartNo | Integer | [Definition ETN und DVN](definition-etn-2516.md), 5 Stellen | Die Teilekennung kann 1 - N mal übergeben werden. | X |
...
Die Rückgabe erfolgt in VXS-Struktur. Zurückgegeben werden 1:N [Dossier](../../vxs/aktenzeichenvo-1369.md), mit Informationen aus [Fahrzeug](../../vxs/aktenzeichenvorgan/fahrzeug-vehic-6692.md), [Ausstattungen zum DAT €uropa-Code, Ausstattungspositionen, Teilepositionen](../../vxs/aktenzeichenvorgan/ausstattungen-1381.md).
