...
- [getExtPartNoInfoByFullVehicleAndIntPartNo](ruckgabe-von-e-2513.md)
- [getExtPartNoInfoByMfrAndExtPartNo](informationser-2543.md)
- [getExtPartNoInfoByModelAndExtPartNo](informationser-2539.md)
- [getExtPartNoInfoByVinAndIntPartNo](ruckgabe-etn-u-2535.md)
- [getModelInfoByMfrAndExtPartNo](ruckgabe-von-m-2520.md)
