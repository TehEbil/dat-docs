...
Mit der Funktion calculateContract() kann ein Vorgang in SilverDAT 3 PRO kalkuliert werden. calculateContract() kann nur im Nachgang zu [importDossier()](../silverdat-calculat/erstellen-aktu-1367.md) durchgeführt werden, weil die contractId, die von [importDossier](../silverdat-calculat/erstellen-aktu-1367.md)() zurückgegeben wird, ein Pflichtparameter von calculateContract() ist.
