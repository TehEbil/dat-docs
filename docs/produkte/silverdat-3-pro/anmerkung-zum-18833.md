...
POST Anfrage statt. Zum generieren des Tokens lesen Sie bitte den Bereich [Authentifizierung der SilverDAT](../../allgemein/dat-developers-gui/authentifizier-1294.md) Webservices.
