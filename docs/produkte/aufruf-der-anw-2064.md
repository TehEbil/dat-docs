...
werden kann, finden Sie im Kapitel [Beispiel für den Daten-Upload via POST](#showid/2068 "Beispiel für den Daten-Upload via POST"). Das Beispiel zeigt die zwei Möglichkeiten des Daten-Uploads, jeweils dargestellt
...
Ein Beispiel für eine entsprechende VXS-Datei finden Sie im Kapitel [Beispiel VXS-Datei Auftragseroeffnung](#showid/2070 "Beispiel VXS-Datei Auftragseröffnung"). Informationen zum genutzten VXS-Schema finden Sie in der Dokumentation VXS-Struktur.
