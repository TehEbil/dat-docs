...
topic_id: "2244"
breadcrumb: "SilverDAT Produkte > SilverDAT 3 valuateFinance > Integration der Oberfläche > Aufruf der Oberfläche > Aufbereitung der Authentifizierungsinformationen"
---

# Aufbereitung der Authentifizierungsinformationen

Die Anmeldung an SilverDAT 3 valuateFinance über die Oberflächen-Schnittstelle erfolgt entsprechend der Anmeldung bei den Soap-Funktionen
zweistufig mittels der JSON Web Token Authentifikation. Im ersten Schritt erstellen Sie das Token mittels der Funktion
JSON.stringify und im zweiten Schritt melden Sie sich mittels der Funktion sphinx.credentials an. Das DAT-AuthorizationToken hat eine Gültigkeit von 30 Minuten. Die Anmeldedaten
...
| Name | Datentyp | mögliche Werte | Beschreibung | Pflichtfeld |
| --- | --- | --- | --- | --- |
| token | string | 670a8f439c... | Generierter SHA256 Hash für den Benutzer. | X |
