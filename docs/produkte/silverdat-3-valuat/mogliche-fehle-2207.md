---
title: "Mögliche Fehlercodes getVehicleTargetDateEvaluationHistoryResponse"
topic_id: "2207"
breadcrumb: "SilverDAT Produkte > SilverDAT 3 valuateFinance > Schnittstellenoperationen > Stichtagsbezogene Bewertung durchführen (Historische Bewertung) > Mögliche Fehlercodes getVehicleTargetDateEvaluationHistoryResponse"
---

# Mögliche Fehlercodes getVehicleTargetDateEvaluationHistoryResponse
...
| dat:validation.evaluationDate.missing | Das Bewertungsdatum fehlt. | Der Parameter evaluationDate fehlt. Bitte geben Sie den Parameter evaluationDate im Request an. |
| dat:validation.evaluationDate.outOfRange | Das Bewertungsdatum ist außerhalb des möglichen Bewertungszeitraumes. | Das Bewertungsdatum ist außerhalb des möglichen Bewertungszeitraumes. Bitte korrigieren Sie den Wert des Parameters evaluationDate und führen die Abfrage erneut aus. |
