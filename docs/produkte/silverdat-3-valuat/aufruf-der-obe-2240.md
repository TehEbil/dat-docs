...
| sphinx.params | Setzen der spezifischen Einstellungen für SilverDAT 3 valuateFinance:    datCountryIndicator - Landesflag für den Zielmarkt; ISO 3166 ALPHA-2  locale - Sprachkürzel (Language)  action - Aktionstyp  dossierid - Eindeutige Vorgangskennung entsprechend [Verwalten von Vorgängen](../allgemeine-service/funktionsumfan-15005.md)  type - Typ des anzulegenden Vorgangs  vxs - VXS-Vorgangsdaten; Pflicht für Aktion importDossier  page - [Aufrufziel](aufrufziele-2246.md) (Seite)  workflow - boolean; Berechtigung zum Navigieren innerhalb des Vorgangs  save - boolean; Berechtigung zum Speichern des Vorgangs |
