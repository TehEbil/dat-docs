...
topic_id: "25304"
breadcrumb: "SilverDAT Produkte > SilverDAT 3 valuateExpert > Schnittstellenoperationen > Benutzerdefinierte Handelsspanne > Benutzerdefinierte Handelsspanne holen > Response getValueInfluencingFactors"
---
...
   <S:Body>
      <ns5:getValueInfluencingFactorsResponse xmlns:ns5="http://www.dat.de/services/Dossier1N">
         <getValueInfluencingFactorsResponse>
...
            <MarginFromFactorsNet>600</MarginFromFactorsNet>
            <MarginFromFactorsGross>714</MarginFromFactorsGross>
...
                  <Designation>Preparation costs</Designation>
                  <Occurrence>One-off factor</Occurrence>
                  <Category>Cost factor</Category>
                  <Period>Total days on lot</Period>
...
                  <IntoAccountCheck>true</IntoAccountCheck>
                  <Designation>Overheads</Designation>
                  <Occurrence>Recurring factor</Occurrence>
                  <Category>Cost factor</Category>
...
                  <IntoAccountCheck>true</IntoAccountCheck>
                  <Designation>Profit</Designation>
                  <Occurrence>One-off factor</Occurrence>
                  <Category>Profit factor</Category>
                  <Period>Total days on lot</Period>
...
                  <IntoAccountCheck>true</IntoAccountCheck>
                  <Designation>Capital interest</Designation>
                  <Occurrence>Recurring factor</Occurrence>
                  <Category>Cost factor</Category>
...
                  <IntoAccountCheck>true</IntoAccountCheck>
                  <Designation>Sales commission</Designation>
                  <Occurrence>One-off factor</Occurrence>
                  <Category>Provision factor</Category>
                  <Period>Total days on lot</Period>
...
                  <IntoAccountCheck>true</IntoAccountCheck>
                  <Designation>Depreciation</Designation>
                  <Occurrence>Recurring factor</Occurrence>
                  <Category>Cost factor</Category>
                  <Period>Annually</Period>
...
            </ValueInfluencingFactorList>
         </getValueInfluencingFactorsResponse>
      </ns5:getValueInfluencingFactorsResponse>
   </S:Body>
</S:Envelope>
```
