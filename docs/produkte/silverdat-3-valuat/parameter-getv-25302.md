---
title: "Parameter getValueInfluencingFactors"
topic_id: "25302"
breadcrumb: "SilverDAT Produkte > SilverDAT 3 valuateExpert > Schnittstellenoperationen > Benutzerdefinierte Handelsspanne > Benutzerdefinierte Handelsspanne holen > Parameter getValueInfluencingFactors"
---

# Parameter getValueInfluencingFactors

Request getValueInfluencingFactors

| Parameter | Datentyp | Beschreibung | Schreibweise | Pflicht |
| --- | --- | --- | --- | --- |
| DossierId | Long | Eindeutige Vorgangskennung | numerisch | X |
| VehicleType | Long | Fahrzeugart | 2 = Lkw 4 = Motorrad 5 = Pkw 6 = Transporter 8 = SUV 90= frei definierte Fahrzeugart |  |
