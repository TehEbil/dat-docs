...
| sphinx.credentials | Anmeldeinformation; Die Beschreibung der Parameter finden Sie unter [Aufbereitung der Authentifizierungsinformationen](#showid/2244 "Aufbereitung der Authentifizierungsinformationen"). |
| sphinx.params | Setzen der spezifischen Einstellungen für SilverDAT 3 valuateFinance:    datCountryIndicator - Landesflag für den Zielmarkt; ISO 3166 ALPHA-2  locale - Sprachkürzel (Language)  action - Aktionstyp  dossierid - Eindeutige Vorgangskennung entsprechend [Verwalten von Vorgängen](#showid/15005 "Funktionsumfang Vorgangsverwaltung")  type - Typ des anzulegenden Vorgangs  vxs - VXS-Vorgangsdaten; Pflicht für Aktion importDossier  page - [Aufrufziel](#showid/2246 "Aufrufziele") (Seite)  workflow - boolean; Berechtigung zum Navigieren innerhalb des Vorgangs  save - boolean; Berechtigung zum Speichern des Vorgangs |
