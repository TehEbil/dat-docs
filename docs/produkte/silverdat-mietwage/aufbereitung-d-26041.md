...
hierzu finden Sie unter [Aufbereitung der Authentifizierungsinformationen](../silverdat-3-valuat/aufbereitung-d-2322.md). Ein einfaches Beispiel zur Übergabe des Tokens sieht wie folgt aus:
