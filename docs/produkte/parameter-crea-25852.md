---
title: "Parameter createDossierN"
topic_id: "25852"
breadcrumb: "SilverDAT Produkte > Allgemeine Services > Verwalten von Vorgängen > Funktionsumfang Vorgangsverwaltung > Erstellen eines neuen Vorgangs > Parameter createDossierN"
---

# Parameter createDossierN
...
Request createDossierN
   ...
   Element vxs:Dossier
                  ...
                  EVALUATION = aktuelle Bewertung, HISTORIC EVALUATION = hist. Bewertung¹valuateExpert = hist. Bewertung³valuateExpertPlusPartner = hist. Bewertung³ EVALUATION= Default Wert
   ...
   Element vxs:Vehicle
                  ...
                  Bauzeit²weitere Infos siehe Popup-FensterPflicht für Gebrauchtfahrzeuge. 
                  ...
                  ErstzulassungsdatumPflicht für Gebrauchtfahrzeuge
                  ...
                  Enthält die Reifendaten als Unterelemente
                  ...
                  vxs:ConstructionYear³
               
               
                  Integer
               
               
                  Baujahr in DAT-Notation (3000-Kalenderjahr)
               
               
                  3-stelllig, numerisch
   ...
   Element vxs:Valuation
                  ...
                  Bewertungsart.Pflicht für pauschale Ausstattungswerte;Standardwert ist VALUATION; Wird der Wert NEW VEHICLE gewählt, werden die Felder MileageEstimated und InitialRegistration ignoriert. NEW VEHICLE ist nur in Verbinding mit DossierType = EVALUATION möglich.
               
               
                  VALUATION = Gebrauchtfahrzeug,NEW VEHICLE = Neufahrzeug
                  residual value new vehicle = Neufahrzeugrestwertprognose
                  ...
                  Bewertungs-Stichtag (Defaultwert = aktuelles Datum), Werte in der Vergangenheit oder
                     dem aktuellen Monat
                  ...
                  Pflicht bei pauschaler Wertermittlung.
                  ...
                  Restwertprognosen; Enthält 0 bis n Positionen vxs:Forecast. Momentan wird nur ein Datensatz unterstützt.
   ...
   Element vxs:RegistrationData
                  ...
                  KbaCode, Bitte geben Sie nur einen KbaCode an
   ...
   Element vxs:Equipment
                  ...
                  Sonderausstattungen; Enthält 0 bis n Positionen vxs:EquipmentPosition als Unterlemente
                  ...
                  Zusatzausstattungen; Enthält 0 bis n Positionen vxs:EquipmentPosition als Unterlemente
   ...
   Element vxs:EquipmentPosition
                  ...
                  Name/Beschreibung der Ausstattungnur bei Zusatzausstattung möglich
                  ...
                  Prozentuale Abwertung der Sonderausstattung. Pflicht, wenn das Element DecreaseType mit dem Wert Percentage belegt wird (nur für SilverDAT 3 valuateExpert verfügbar)
                  ...
                  Neupreis ( Netto)nur bei Zusatzausstattung möglichWird nur in den Neupreis der gesamten Ausstattung gerechnet, wenn InstallDate vor dem Erstzulassungsdatum liegt oder nicht gesetzt ist
                  ...
                  Neupreis ( Brutto)nur bei Zusatzausstattung möglichWird nur in den Neupreis der gesamten Ausstattung gerechnet, wenn InstallDate vor dem Erstzulassungsdatum liegt oder nicht gesetzt ist
   ...
   Element vxs:TechInfo für Aufbauten ²
