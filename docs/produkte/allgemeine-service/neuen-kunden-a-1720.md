...
Die Funktion kann ebenfalls dazu verwendet werden, um einen über die Funktion [disableCustomer](kunde-deaktivi-1736.md) deaktivierten Kunden wieder zu reaktivieren.
