...
hierzu finden Sie unter [Aufbereitung der Authentifizierungsinformationen](#showid/2322 "Aufbereitung der Authentifizierungsinformationen"). Ein einfaches Beispiel zur Übergabe des Tokens sieht wie folgt aus:
...
beachten Sie bei Verwendung der Seitenliste, die in [Aufruf der Oberfläche](#showid/2318 "Aufruf der Methoden von SilverDAT 3 valuateExpert Oberflächeintegration") beschriebenen Bedingungen.
