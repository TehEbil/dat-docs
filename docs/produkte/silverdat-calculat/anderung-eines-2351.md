...
| generation | Integer, Pflicht | Interval [1-10] | 1= Die aktuellste Preisstandänderung  10= Letzter Eintrag in der Historie    Dieser Wert kann über die Funktion [getContractPriceGenerations](abruf-aller-vo-2343.md) abgefragt werden. |
