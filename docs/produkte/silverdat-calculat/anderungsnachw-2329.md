...
| 4.8 | 10.10.2023 | Neue Funktion [getAdditionalItems()](abrufen-der-zu-22521.md) in [VehicleRepairService](vehiclerepairs-2413.md)  Neues Attribut automaticVinRequest in der Funktion [importDossier()](erstellen-aktu-1367.md)  Neues Attribut createUser in der Funktion [getContractList()](request-getdvn-2417.md) |
