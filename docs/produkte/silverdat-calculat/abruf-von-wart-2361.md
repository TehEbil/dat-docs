...
Als Eingabe dienen dabei der DAT €uropa-Code® (datECode), die Bauzeit (constructionTime) und die Locale (locale), wie im Kapitel [Element locale](../../allgemein/dat-developers-gui/element-locale-1352.md) beschrieben.
