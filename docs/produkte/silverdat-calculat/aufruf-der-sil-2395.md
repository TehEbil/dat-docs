...
|  |  |
| --- | --- |
|  | Bitte lesen Sie in jedem Fall die Kapitel [Aufbereitung der Authentifizierungsinformationen](aufbereitung-d-2397.md), [Callback-Methode für die Verarbeitung eines abgeschlossenen Vorgangs](callback-metho-2399.md) und [Callback-Methode für Fehlerbehandlungen](callback-metho-2402.md), bevor Sie mit diesem Topic fortfahren. |
| Tipp |
