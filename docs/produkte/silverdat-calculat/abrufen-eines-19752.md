...
Als Eingabe dient dabei die Vorgangsnummer (contractID), die wie unter Anlage eines neuen Vorgangs beschrieben erlangt werden kann. Optional kann auch der Parameter "[locale](../../allgemein/dat-developers-gui/element-locale-1352.md)" mit übergeben werden. Dadurch lässt sich das Kalkulationsergebnis in der gewünschten
Sprache abrufen.
