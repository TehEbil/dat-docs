---
title: "getOptionsbyClassification"
topic_id: "1925"
breadcrumb: "SilverDAT Produkte > DAT €uropa-Code® Fahrzeugauswahl > Fahrzeugauswahl - Funktionen > getOptionsbyClassification"
---

# getOptionsbyClassification

Beschreibung

Allgemeingültige Funktion, der man die Klassifizierung der AV aus [getClassificationGroups](#showid/1921 "getClassificationGroups") als Parameter mitgeben kann. Dies vereinfacht den Zugriff auf die Untertypvarianten.
...
| Classification | Integer | getClassificationGroups | [Klassifizierende Ausstattungen](#showid/1820 "Klassifizierende Ausstattungen") | X |
...
Liste der verfügbaren Ausstattungsvarianten und ihrer Bezeichnungen analog zum übergebenen
Basiscode (Fahrzeugart, Hersteller, Haupttyp, Untertyp) und der (optional) bereits
gewählten Ausstattungsvarianten, eingeschränkt durch die klassifzierende Ausstattungsgruppe.
