...
| signature | String | s. Beschreibung | Codierter Base64 String, analog zum Kapitel [Authentifizierung der SilverDAT Webservices](../../allgemein/dat-developers-gui/authentifizier-1294.md) | Y |
