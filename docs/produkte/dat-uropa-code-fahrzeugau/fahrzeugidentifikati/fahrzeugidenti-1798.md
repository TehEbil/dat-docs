...
wenn die VIN-Abfrage, nur die [Datenkarte](ecode-not-foun-11682.md) liefert (<faultcode>dat:dat:Server.valueNotFound). Weitere Informationen können Sie dann aus dem Element <faultstring> innerhalb <additionalInformation> entnehmen.  
