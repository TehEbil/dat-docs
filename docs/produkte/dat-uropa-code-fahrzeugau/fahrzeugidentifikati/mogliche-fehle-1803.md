...
| valueNotFound | Ecode not found. | Mit diesen Werten kann kein gültiger DAT €uropa-Code® gefunden werden. Im Fall, dass die Herstellerdaten zur Verfügung stehen, werden sie als String in Form einer [Datenkarte](ecode-not-foun-11682.md) zurückgegeben. |
...
Weitere Fehlercodes entnehmen sie bitte aus der Liste der [Test-VIN für Fehlermeldungen](test-vin-fur-f-1796.md).
