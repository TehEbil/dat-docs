...
Allgemeingültige Funktion, der man die Klassifizierung der AV aus [getClassificationGroups](getclassificat-1921.md) als Parameter mitgeben kann. Dies vereinfacht den Zugriff auf die Untertypvarianten.
...
| Classification | Integer | getClassificationGroups | [Klassifizierende Ausstattungen](../klassifizieren-1820.md) | X |
