...
Als Eingabe dient dabei die Vorgangsnummer (contractID), die wie unter Anlage eines neuen Vorgangs beschrieben erlangt werden kann. Optional kann auch der Parameter "[locale](#showid/1352 "Element locale ")" mit übergeben werden. Dadurch lässt sich das Kalkulationsergebnis in der gewünschten
Sprache abrufen.
...
| --- | --- | --- |
| [Dossiers](#showid/1369 "Aktenzeichen/Vorgänge (Dossiers)") | [Dossiers](#showid/1369 "Aktenzeichen/Vorgänge (Dossiers)") | Fahrzeugdossier inkl. Kalkulationsergebnis |
