...
| constructionTimeFrom | Integer | s. [date2ConstructionTime](#showid/1807 "date2ConstructionTime") | Bauzeit von |  |
...
- Die Ergebnismenge wird jeweils anhand eines [Response getSubModelsByTextSearch](#showid/1809 "Response getSubModelsByTextSearch") zurückgegeben.
