...
topic_id: "24830"
breadcrumb: "SilverDAT Produkte > SilverDAT calculatePro / SilverDAT calculateExpert > Schnittstellenoperationen > PartsService > Ermittlung von DAT €uropa-Code, Fahrzeuginformationen, DVNs und Preishistorie"
---
...
| --- | --- | --- | --- |
| [sparePartsResultPerSparePartNumber](#showid/17205 "SparePartsResultPerSparePartNumber") | [SparePartsResultPerSparePartNumber](#showid/17205 "SparePartsResultPerSparePartNumber") [] | Ergebnisse der Ersatzteilnummer (ohne Fahrzeuginformationen) |  |
| Dossier | complexType, Dossier | Liste Fahrzeugidentifikation nach DAT im VXS-Format | [Country | Language | Vehicle]    Country (String3): Landeskürzel für den Zielmarkt  Language (String5): Sprachkennzeichen in ISO-Kodierung  [Vehicle](#showid/6692 "Fahrzeug (Vehicle)") ([Vehicle](#showid/6692 "Fahrzeug (Vehicle)")): Fahrzeugdaten |
