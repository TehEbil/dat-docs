...
| DATEquipmentId | Integer | Hier können 0-n DAT AV-Nummern der [klassifizierenden Ausstattung](../../dat-uropa-code-fahrzeugau/klassifizieren-1820.md) übergeben werden. Die Übergabe von Sonderausstattungen ist nicht möglich! |
