---
title: "getTypeOfDriveOptions"
topic_id: "1967"
breadcrumb: "SilverDAT Produkte > DAT €uropa-Code® Fahrzeugauswahl > Fahrzeugauswahl - Funktionen > getTypeOfDriveOptions"
---

# getTypeOfDriveOptions

Beschreibung

Funktion zur Auswahl der verfügbaren Antriebsart-Ausstattungsvarianten in Abhängigkeit
vom Basiscode (Fahrzeugart, Hersteller, Haupttyp, Untertyp) und (optional) bereits
gewählten Ausstattungsvarianten. Nur Fahrzeugarten Geländefahrzeug und Transporter.
...
Liste der verfügbaren Antriebsart-Ausstattungsvarianten und ihren Bezeichnungen entsprechend
des übergebenen Basiscodes (Fahrzeugart, Hersteller, Haupttyp, Untertyp) und der (optional)
