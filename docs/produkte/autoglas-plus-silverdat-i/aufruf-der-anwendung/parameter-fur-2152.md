...
| signature | String | s. Beschreibung | Codierter Base64 String, analog zum Kapitel [Authentifizierung der SilverDAT Webservices](../../../allgemein/dat-developers-guide/authentifizierung-de/index.md) | Y |
