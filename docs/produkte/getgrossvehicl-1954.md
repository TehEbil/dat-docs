---
title: "getGrossVehicleWeightOptions"
topic_id: "1954"
breadcrumb: "SilverDAT Produkte > DAT €uropa-Code® Fahrzeugauswahl > Fahrzeugauswahl - Funktionen > getGrossVehicleWeightOptions"
---

# getGrossVehicleWeightOptions

Beschreibung

Funktion zur Auswahl der verfügbaren Tonnageklasse-Ausstattungsvarianten in Abhängigkeit
vom Basiscode (Fahrzeugart, Hersteller, Haupttyp, Untertyp) und (optional) bereits
gewählten Ausstattungsvarianten. Nur für Fahrzeugart=4.
...
Liste der verfügbaren Tonnageklasse-Ausstattungsvarianten und ihren Bezeichnungen
analog zum übergebenen Basiscode (Fahrzeugart, Hersteller, Haupttyp, Untertyp) und
der (optional) bereits gewählten Ausstattungsvarianten.
