...
topic_id: "30670"
breadcrumb: "Technische Informationen > Ausgabe Nr. 92 August 2025 > Übersicht geplanter Änderungen"
---
...
| TradingActivity.Purchase | CustomerId |
| TaxationType |
| UserId |
| AcceptanceType |
| TradingActivity.Admission | CustomerId |
| PurchasePriceNet |
| PurchasePriceGross |
| TaxationType |
| BusinessType |
...
| Buyer |
| FollowUpBusiness |
| TradingActivity.FollowUpBusiness | FollowUpBusinessType |
| BusinessType |
| VehicleNo |
| VehicleIdentNo |
| KbaKey |
| Details |
| TradingActivity.Sale | CustomerId |
| LicenseNumber |
| ProcedureName |
| RenewMot |
| Purchaser |
