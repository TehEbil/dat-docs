---
title: "Beschreibung Zusatzelement 1"
topic_id: "2839"
breadcrumb: "Datenlieferungen > Satzbeschreibung DAT €uropa-Code > Beschreibung Zusatzelement 1"
---

# Beschreibung Zusatzelement 1

Bauzeiten und Ausstattungsvarianten

Das Zusatzelement 1 liefert die Serien- und Sonderausstattung zu einem DAT €uropa-Code®
...
Der Name der XML-Root-Elements lautet „zusatz1" und der Name eines Satz-Elements lautet
„zusatz1\_s".
...
Der Name des entsprechenden XML-Root-Elements lautet „zusatz1\_av" und der Name eines
Satz-Elements lautet „zusatz1\_av\_s". Zusatz1\_av enthält alle AV pro Haupttyp und zusatz1\_av\_s
enthält alle AV pro Hersteller.

Achtung: Sowohl in zusatz1\_av als auch in zusatz1\_av\_s befinden sich nur bewertbare
Ausstattungen!  
Ausstattungen mit Sperrkennzeichen für die Fahrzeugbewertung werden nicht ausgegeben.  
...
Der Name der XML-Root-Elements lautet „zusatz1\_bz" und der Name eines Satz-Elements
lautet „zusatz1\_bz\_s".

Bei den Marktindizes wird pro DAT €uropa-Code®-Marktindex ein Satz ausgegeben.

Der Name des XML-Root-Elements ist „zusatz1\_con", der Name eines Satz-Elements „zusatz1\_con\_s".
