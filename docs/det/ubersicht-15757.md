...
DAT-AuthorizationToken übergeben werden. Dieser Schlüssel muss vorher aus der login-Funktion erfragt werden (siehe Abschnitt [Anmeldung (Funktionen)](#showid/22823 "Anmeldung")). Beachten Sie, dass die Anmeldefunktionen einen anderen Pfad benutzen als die Datenabfragefunktionen
