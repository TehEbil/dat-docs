...
DAT-AuthorizationToken übergeben werden. Dieser Schlüssel muss vorher aus der login-Funktion erfragt werden (siehe Abschnitt [Anmeldung (Funktionen)](anmeldung-22823.md)). Beachten Sie, dass die Anmeldefunktionen einen anderen Pfad benutzen als die Datenabfragefunktionen
