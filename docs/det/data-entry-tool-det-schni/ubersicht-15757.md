...
title: "Übersicht"
topic_id: "15757"
breadcrumb: "Data Entry Tool (DET) - Schnittstelle zum Datenabruf > Data Entry Tool (DET) - Schnittstelle zum Datenabruf > Übersicht"
---
...
DAT-AuthorizationToken übergeben werden. Dieser Schlüssel muss vorher aus der login-Funktion erfragt werden (siehe Abschnitt [Anmeldung (Funktionen)](funktionsreferenz/anmeldung-22823.md)). Beachten Sie, dass die Anmeldefunktionen einen anderen Pfad benutzen als die Datenabfragefunktionen
