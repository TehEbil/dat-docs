...
DAT-AuthorizationToken übergeben werden. Dieser Schlüssel muss vorher aus der login-Funktion erfragt werden (siehe Abschnitt [Anmeldung (Funktionen)](funktionsreferenz/anmeldung-27906.md)). Beachten Sie, dass die Anmeldefunktionen einen anderen Pfad benutzen als die Datenabfragefunktionen
