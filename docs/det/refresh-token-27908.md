...
title: "Refresh Token"
topic_id: "27908"
breadcrumb: "Data Entry Tool (DET) - Schnittstelle zum Datenabruf > Data Entry Tool (DET) 2026 - Schnittstelle zum Datenabruf > Funktionsreferenz > Anmeldung > Refresh Token"
---
...
(accessToken). Dennoch läuft er irgendwann (nach einigen Stunden) ab. Ein neuer Token kann nur
mittels einer neuen Anmeldung über die Funktion login abgefragt werden.
