...
topic_id: "22640"
breadcrumb: "Data Entry Tool (DET) - Schnittstelle zum Datenabruf > Data Entry Tool (DET) - Schnittstelle zum Datenabruf > Anmeldung > Zugriff vom Webbrowser aus"
---

# Zugriff vom Webbrowser aus

Wenn die Schnittstelle direkt vom Web-Browser aus aufgerufen wird, speichern Sie die
Zugangsdaten nicht im Session-Storage, sondern nur den Zugangs-Token.
