...
Bitte lesen Sie die Kapitel [Wurzelelement svg](#showid/1611 "Wurzelelement svg"), [Element constructionGroup](#showid/1612 "Element constructionGroup"), [Element g](#showid/1616 "Element g") und [Element metadata](#showid/1620 "Element metadata"), um eine Übersicht zu erhalten, welche Werte Sie auslesen und mit einem Event-Handling
verknüpfen können.
