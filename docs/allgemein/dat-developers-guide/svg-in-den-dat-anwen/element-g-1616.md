...
| --- | --- | --- | --- | --- |
| g | Gruppierungselement; enthält u.a. den Namen des graphischen Teilstückes, die [geometrischen Zeichenelemente und -pfade](geometrische-z-1618.md), die die Grafik darstellen | P / V | X | N-mal |
| [metadata](element-metada-1620.md) | allgemeine Metainformationen; enthält Name, Übersetzungen DVN-Nummer, Lage am/im Fahrzeug etc. des graphischen Teils | P / V | X | N-mal |

Ein Beispiel hierzu finden Sie im Kapitel [Element metadata](element-metada-1620.md), zusammen mit einer beispielhaften Anzeige für die metadata.
