...
Namespace identifiziert wird. Gesucht wird erst ab dem [Gruppenelement](element-g-1616.md) "Standardebene".

Im nachfolgenden Beispiel wird allen Elementen, die ein Element <[metadata](element-metada-1620.md)> besitzen, ein Event-Listener zugewiesen, der auf Anklicken oder Überfahren mit dem
Cursor reagiert.
