...
- SOAP-Request "generateToken" an den [AuthenticationService der jeweiligen Anwendung](soap-request-g-14126.md)
- Http POST-Request an den [AuthorizationManager tokenService](http-post-requ-14131.md)
